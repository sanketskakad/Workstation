...
async function seedDatabase() {
  try {
    ...
    const apiGateway = await Project.create({
      ...
      teamObjective:
        "Build unified API layer with improved rate limiting and authentication.",
    ...
    for (let week = 3; week <= 4; week++) {
      const weekStart = new Date(
        baseDate.getTime() - (15 - week * 7) * 24 * 60 * 60 * 1000,
      );
      ...
      const weekTasks = [
        {
          ...
          priority: "high",
          assignee: "Lina Chen",
          dueDate: new Date(weekStart.getTime() + 3 * 24 * 60 * 60 * 1000)
            .toISOString()
            .split("T")[0],
        ...
        },
        {
          ...
          dueDate: new Date(weekStart.getTime() + 4 * 24 * 60 * 60 * 1000)
            .toISOString()
            .split("T")[0],
          project: mobileApp.name,
          projectId: mobileApp._id,
        ...
        },
        {
          ...
          priority: "medium",
          assignee: "David Kim",
          dueDate: new Date(weekStart.getTime() + 5 * 24 * 60 * 60 * 1000)
            .toISOString()
            .split("T")[0],
        ...
        },
        {
          ...
          dueDate: new Date(weekStart.getTime() + 6 * 24 * 60 * 60 * 1000)
            .toISOString()
            .split("T")[0],
          project: cloudMigration.name,
          projectId: cloudMigration._id,
    ...
    const currentTasks = [
      {
        ...
        priority: "high",
        assignee: "John Doe",
        dueDate: new Date(currentWeekStart.getTime() - 2 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        project: mobileApp.name,
        projectId: mobileApp._id,
        ...
        completedAt: new Date(
          currentWeekStart.getTime() - 2 * 24 * 60 * 60 * 1000,
        ),
      },
      {
        ...
        priority: "high",
        assignee: "Marcus Patel",
        dueDate: new Date(currentWeekStart.getTime() + 5 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        project: mobileApp.name,
        projectId: mobileApp._id,
      ...
      },
      {
        ...
        priority: "medium",
        assignee: "David Kim",
        dueDate: new Date(currentWeekStart.getTime() + 7 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        project: mobileApp.name,
        projectId: mobileApp._id,
      ...
      },
      {
        ...
        description:
          "Configure CloudWatch and ELK stack for production monitoring.",
        status: "inprogress",
        priority: "high",
        assignee: "Sarah Johnson",
        dueDate: new Date(currentWeekStart.getTime() + 8 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        project: cloudMigration.name,
        projectId: cloudMigration._id,
      ...
      },
      {
        ...
        priority: "medium",
        assignee: "Lina Chen",
        dueDate: new Date(currentWeekStart.getTime() + 6 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        project: apiGateway.name,
        projectId: apiGateway._id,
      ...
      },
      {
        ...
        priority: "medium",
        assignee: "John Doe",
        dueDate: new Date(currentWeekStart.getTime() + 10 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        project: apiGateway.name,
        projectId: apiGateway._id,
